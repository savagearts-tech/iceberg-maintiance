 ...
 * <ul>
 *   <li>{@code uri} — JDBC connection URL (or {@code jdbc.url})</li>
 *   <li>{@code warehouse} — Iceberg warehouse location (required)</li>
 *   <li>{@code user} — database user (or {@code jdbc.user})</li>
 *   <li>{@code password} — database password (or {@code jdbc.password})</li>
 * </ul>
 */
