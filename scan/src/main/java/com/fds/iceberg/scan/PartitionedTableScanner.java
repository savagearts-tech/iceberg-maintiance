...
import com.fds.iceberg.common.PartitionPrefixGenerator;
...
public class PartitionedTableScanner {
    ...
    // cached scan result — avoids double planFiles() when both
     ...
     * Results are cached — a second call returns the same set without re-scanning.
     *
     ...
     * e.g. {@code year=2026/month=05/day=26} → {@code ["2026","05","26"]}
     */
